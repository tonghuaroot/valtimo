...
* [🗃️ Cases](configuration-guides/cases/README.md)
    * [General](configuration-guides/cases/general.md)
    * [Processes](configuration-guides/cases/processes.md)
    ...
    * [Tasks](configuration-guides/cases/tasks/README.md)
        ...
        * [Search fields](configuration-guides/cases/tasks/search-fields.md)
    * [Case list](configuration-guides/cases/case-list/README.md)
        * [List columns](configuration-guides/cases/case-list/list-columns.md)
        * [Search fields](configuration-guides/cases/case-list/search-fields.md)
    * [Case details](configuration-guides/cases/case-details/README.md)
        * [Tabs](configuration-guides/cases/case-details/tabs.md)
        * [Statuses](configuration-guides/cases/case-details/statuses.md)
        * [Tags](configuration-guides/cases/case-details/tags.md)
        * [Header](configuration-guides/cases/case-details/header.md)
    * [ZGW](configuration-guides/cases/zgw/README.md)
        * [General](configuration-guides/cases/zgw/general.md)
        * [Document columns](configuration-guides/cases/zgw/document-columns.md)
        * [Document upload fields](configuration-guides/cases/zgw/document-upload-fields.md)
        * [Document tags](configuration-guides/cases/zgw/document-tags.md)
